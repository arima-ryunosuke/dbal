...
class DiffCommentTest extends AbstractPluginTestCase
{
    ...
    public function testDiffComment(): void
    {
        ...
        $table2->addColumn('col1', 'string', ['notnull' => false]);
        ...
        ], $tableDiff->getModifiedColumns()[0]->getDiff());

        self::assertEquals([[], []], (new TableDiff('foo'))->getDiff());
        self::assertEquals([[], []], (new ColumnDiff('foo', new Column('foo', Type::getType('integer'))))->getDiff());
