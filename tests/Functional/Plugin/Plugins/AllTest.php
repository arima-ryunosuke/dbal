    ...
    public function test_mysql(): void
    {
        ...
        $con1->executeStatement(<<<DDL
            ...
            CREATE TABLE ExampleTable (
              ...
              content TEXT NOT NULL COLLATE utf8mb3_bin,
            ...
            ) Comment='comment_from' CHARSET=utf8mb3 COLLATE='utf8mb3_general_ci' ROW_FORMAT=COMPRESSED;
            ...
            CREATE VIEW ExampleView AS SELECT id, seq, content FROM ExampleTable WITH CASCADED CHECK OPTION;

            CREATE PROCEDURE procedure1(IN arg1 int, IN arg2 int, OUT result int)
            LANGUAGE SQL
            NOT DETERMINISTIC
            READS SQL DATA
            ...
            CREATE FUNCTION function1(arg1 int, arg2 int)
            RETURNS int
            LANGUAGE SQL
            DETERMINISTIC
            READS SQL DATA
        ...
        $con2->executeStatement(<<<DDL
            ...
            CREATE TABLE NewTable (
              id INT(10) UNSIGNED NOT NULL,
              PRIMARY KEY (id)
            ) Comment='new_table' CHARSET=utf8mb3 COLLATE='utf8mb3_bin' ENGINE=InnoDB;
            ...
            CREATE TABLE ExampleTable (
              ...
              content LONGTEXT NOT NULL COLLATE utf8mb3_bin,
            ...
            ) Comment='comment_to' CHARSET=utf8mb3 COLLATE='utf8mb3_bin' ROW_FORMAT=DYNAMIC;
            ...
            CREATE FUNCTION function1(arg1 int, arg2 int, arg3 int)
            RETURNS int
            LANGUAGE SQL
            DETERMINISTIC
            READS SQL DATA
            ...
            CREATE PROCEDURE procedure2(IN arg int, OUT result int)
            LANGUAGE SQL
            NOT DETERMINISTIC
            READS SQL DATA
        ...
        $expecteds = [
            ...
            // contains new table
            "CREATE TABLE NewTable (id INT UNSIGNED NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_bin` ENGINE = InnoDB COMMENT = 'new_table' ROW_FORMAT = Dynamic",
            "CREATE TRIGGER NewTable_trg AFTER INSERT ON NewTable FOR EACH ROW",
            ...
            "CHANGE content content LONGTEXT NOT NULL AFTER hashcode",
            ...
            "CHANGE create_at create_at DATETIME(6)",
            // contains alter table option
            'collation: "utf8mb3_general_ci" => "utf8mb3_bin"',
            'comment: "comment_from" => "comment_to"',
            'row_format: "Compressed" => "Dynamic"',
            "COLLATE `utf8mb3_bin` COMMENT = 'comment_to' ROW_FORMAT = Dynamic",
