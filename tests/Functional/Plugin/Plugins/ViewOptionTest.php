...
class ViewOptionTest extends AbstractPluginTestCase
{
    ...
    public function testDiffView(): void
    {
        ...
        self::assertFalse($comparator->diffView(
        ...
        self::assertTrue($comparator->diffView(
            new View('hoge', 'select 1', ['option' => 1, 'updatable' => true]),
    ...
    public function testView(): void
    {
        ...
        self::assertEquals([
            ...
            'CREATE OR REPLACE VIEW alteredView1 AS select 9 WITH CASCADE CHECK OPTION',
            'CREATE OR REPLACE VIEW alteredView2 AS select 2 WITH LOCAL CHECK OPTION',
