...
{
    public function testSchemaConfig(): void
    {
        $schemaManager = $this->connection->createSchemaManager();
        $config        = $schemaManager->createSchemaConfig();

        self::assertEquals(true, $config->getPositionalColumn());
    }
    ...
    public function testGetColumns(): void
    {
        ...
        self::assertEquals(['primary', 'secondary'], array_keys($table->getColumns()));

        $schemaManager = $this->connection->createSchemaManager();
        $config        = $schemaManager->createSchemaConfig();

        $table->setSchemaConfig($config);
        self::assertEquals(['secondary', 'primary'], array_keys($table->getColumns()));
    }
