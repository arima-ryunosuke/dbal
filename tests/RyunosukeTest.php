...
final class RyunosukeTest extends TestCase
{
    public function test_integrate(): void
    {
        ...
        $expecteds = [
            ...
            // contains new table
            "CREATE TABLE NewTable (id INT UNSIGNED NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8_bin` ENGINE = InnoDB",
            "CREATE TRIGGER NewTable_trg AFTER INSERT ON NewTable FOR EACH ROW",
            // contains alter table column
            "ADD name VARCHAR(64) CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8_bin` AFTER hashcode",
            "CHANGE hashcode hashcode BINARY(40) NOT NULL AFTER seq",
            "CHANGE content content MEDIUMTEXT CHARACTER SET utf8mb3 NOT NULL COLLATE `utf8_bin` AFTER name",
