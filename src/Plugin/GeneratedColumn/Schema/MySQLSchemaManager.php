...
trait MySQLSchemaManager
{
     ...
     */
    protected function interceptSelectTableColumnsByGeneratedColumn(string $sql): array
    {
        $sql = strtr($sql, [
     ...
     */
    protected function intercept_GetPortableTableColumnDefinitionByGeneratedColumn(array $tableColumn, Column $column): array
    {
