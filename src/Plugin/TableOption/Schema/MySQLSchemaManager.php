...
trait MySQLSchemaManager
{
     ...
     */
    protected function interceptFetchTableOptionsByTableByTableOptionForSql(string $sql)
    {
        $sql = strtr($sql, [
     ...
     * @used-by \Doctrine\DBAL\Schema\MySQLSchemaManager::fetchTableOptionsByTable()
     */
    protected function interceptFetchTableOptionsByTableByTableOptionForTableOptions($tableOptions, $metadata)
    {
