...
{
    protected function _getPortableEventDefinition($event): Event
    {
        ...
        $event['interval'] = (static function ($field, $value) {
            ...
            switch (strtoupper($field)) {
                default:
                    throw NotSupported::new("unknown intervalField '$field'"); // @codeCoverageIgnore
