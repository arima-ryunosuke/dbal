...
use Doctrine\DBAL\Plugin\ViewOption\Schema\Exception\ViewAlreadyExists;
...
trait Schema
{
     ...
     */
    protected function intercept__CloneByViewOption()
    {
    ...
    {
        $name = $this->getFullQualifiedAssetName($viewName);
