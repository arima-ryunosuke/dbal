...
trait SQLiteSchemaManager
{
    /**
     * @codeCoverageIgnore
     * @used-by \Doctrine\DBAL\Schema\SQLiteSchemaManager::_getPortableTableColumnDefinition()
     */
    protected function intercept_GetPortableTableColumnDefinitionByView(array $tableColumn): array
    {
