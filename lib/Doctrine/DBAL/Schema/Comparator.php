...
class Comparator
{
    ...
    public function diffTable(Table $table1, Table $table2)
    {
        ...
        $table1Triggers = $table1->getTriggers();
        $table2Triggers   = $table2->getTriggers();
        ...
        $tableDifferences->changedOptions = $array_diff_assoc_recursive($table2->getOptions(), $table1->getOptions());
    ...
    public function diffColumn(Column $column1, Column $column2)
    {
        ...
        if (
            ...
            $properties1['type'] instanceof Types\BinaryType || $properties1['type'] instanceof Types\TextType || $properties1['type'] instanceof Types\BlobType
        ) {
